...
export function GetVirtualMachine(_: GetVirtualMachineProps) {
    ...
    const reload = () => {
        ...
        client.getVirtualMachine(request, null, (err, res) => {
            ...
            setVM(res);
            setLoc(
                `http://${Config.VMConsoleFQDN}/n0core/static/virtual_machines/vnc.html?path=n0core/api/v0/virtual_machines/${name}/vncwebsocket`
            );
        });
    };
    useEffect(() => reload(), []);
    ...
    return (
        <>
            <Container>
                <Typography variant="h5">Get VirtualMachine</Typography>
                <Card>
                    <CardContent>
                        <Typography variant="h6">Name</Typography>
                        <Typography variant="body1">{vm.getName()}</Typography>
                        ...
                        <Typography variant="h6">memory(MB)</Typography>
                        <Typography variant="body1">
